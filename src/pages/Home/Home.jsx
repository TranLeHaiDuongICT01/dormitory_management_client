        ...
        <div className='pt-24'>
          <div className='container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center'>
            ...
            <div className='flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left'>
              <p className='uppercase tracking-loose w-full'>Bạn chưa có chỗ ở?</p>
              <h1 className='my-4 text-5xl font-bold leading-tight'>Hãy đến với Ký Túc Xá!</h1>
              <p className='leading-normal text-2xl mb-8'>Sạch sẽ,gọn gàng, đầy đủ !</p>

              <Link className='mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out'>
                Đăng ký tài khoản ngay nào
              </Link>
            </div>
            {/*Right Col*/}
            <div className='w-full md:w-3/5 py-6 text-center'>
              <img
                ...
                src='https://hanoi.fpt.edu.vn/wp-content/uploads/2020/07/tienphong_kytucfpt_xzyl.jpg'
              />
            </div>
          </div>
        </div>
